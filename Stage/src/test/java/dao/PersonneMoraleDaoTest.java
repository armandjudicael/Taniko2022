...
public class PersonneMoraleDaoTest {
...
//
    ...
    @Test public void getDemandeurIdBy(){
        ...
        int demandeurIdBy = DaoFactory.getDemandeurMoraleDao().getDemandeurIdBy(demandeurPhysique.getNom(), PersonneMoraleDao.ParamerterType.NAME);
    ...
    public void findbyName() {
        ObservableList<PersonneMorale> observableList = DaoFactory.getDemandeurMoraleDao().findbyName("min", TypeDemandeur.PERSONNE_MORALE_PRIVE);

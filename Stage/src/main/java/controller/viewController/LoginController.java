...
public class LoginController implements Initializable{
    ...
    private void checkUser() {
        ...
        if (userChecked != null){
            ...
            DbUtils.launchQuery(" UPDATE utilisateur SET userStatus = 1 WHERE utilisateur.idUtilisateur =" + userChecked.getId() + ";");
        } else {
            Platform.runLater(() -> {
    ...
    @FXML private void fermerApp(ActionEvent actionEvent) {
    ...
    private void initConnectedUser(User connectedUser ){
        MainController.getInstance().getUserName().setText(connectedUser.getUserName());
    ...
    private void initializeTitledPane() {
        TitledPane titledPane = FolderViewController.getInstance().getTitledPane();
        if (titledPane != null) {
            ...
            @Override protected Void call() throws Exception {
                if (connectedUser == null){
                    ...
                    if (connectedUser.getUserName().equals(username.getText()) && connectedUser.getPassword().equals(password.getText())) {
                        ...
                        DbUtils.launchQuery(" UPDATE utilisateur SET userStatus = 1 WHERE utilisateur.idUtilisateur =" + connectedUser.getId() + ";");
                    } else checkUser();
                }
                return null;
            }
    ...
    @FXML void minimizeLogin(ActionEvent event) {
    ...
    final Image finishedImg = new Image(FolderViewController.class.getResourceAsStream("/img/ok_20px.png"));
    final Image rejectImg = new Image(FolderViewController.class.getResourceAsStream("/img/cancel_20px.png"));
}

    ...
    public void refresh(){
        Task<Void> task = new Task<Void>() {
            ...
            @Override protected void scheduled() {
                userProgress.progressProperty().unbind();
                userProgress.visibleProperty().unbind();
                userProgress.visibleProperty().bind(this.runningProperty());
                userProgress.progressProperty().bind(this.progressProperty());

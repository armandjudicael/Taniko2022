...
public class DashboardController implements Initializable {
    ...
    public void initDashBoard(){
        ArrayList<Integer> dataForDashboard = DaoFactory.getDossierDao().getDataForDashboard(String.valueOf(LocalDate.now().getYear()));
        ObservableList<XYChart.Series<String, Number>> nbAffaireByDateForChart = DaoFactory.getDossierDao().getNbAffaireByDateForChart();

...
public class StatusCell extends ListCell<String>{
    ...
    private static    Image runningImg = new Image(Objects.requireNonNull(FolderViewController.class.getResourceAsStream("/img/play1_20px.png")));
    private static   Image   suspendImg = new Image(Objects.requireNonNull(FolderViewController.class.getResourceAsStream("/img/pause_20px.png")));
    private static    Image   finishedImg = new Image(Objects.requireNonNull(FolderViewController.class.getResourceAsStream("/img/ok_20px.png")));
    private static    Image   rejectImg = new Image(Objects.requireNonNull(FolderViewController.class.getResourceAsStream("/img/cancel_20px.png")));

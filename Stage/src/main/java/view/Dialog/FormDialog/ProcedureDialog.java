...
public class ProcedureDialog extends JFXDialog implements Initializable {
    ...
    private ProcedureDialog() {
        try {
            Node node = new ViewFactory<ProcedureDialog>().create("/fxml/Form/Other/procedureNumForm.fxml", this);
            this.setContent((AnchorPane)node);
    ...
    public void saveProcedure() {
        ...
        FolderForView affair = FolderViewController.getInstance().getTableView().getSelectionModel().getSelectedItem();
...
//            value = DbUtils.insertOnAffAndPrcdTable(idProcedure,
//                    affair.getId(), 0,

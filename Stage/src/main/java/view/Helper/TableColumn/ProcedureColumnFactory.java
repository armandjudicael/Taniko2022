...
public class ProcedureColumnFactory{
    private final static Image goImg = new Image(Objects.requireNonNull(FolderViewController.class.getResourceAsStream("/img/go1.png")));
    private final static Image backImg = new Image(Objects.requireNonNull(FolderViewController.class.getResourceAsStream("/img/back.png")));
    private final static Image noneImg = new Image(Objects.requireNonNull(FolderViewController.class.getResourceAsStream("/img/none.png")));

...
public class Attachement{
    ...
    public Attachement(int idPieceJointe,
                       String description,
    ...
    public Attachement(String description,
                       String extensionPiece,
                       String size,
                       FileInputStream valeur,
                       InputStream inputStream,
    ...
    public Attachement(File selectedFile){
        try {
            ...
            this.status = AttachementStatus.UNKNOWN;
    ...
    private List<AttachComment> comments;

    private static String DOWNLOAD_DIRECTORY;
    private static File downDirectory = null;
    public static ObservableList<AttachementForView> getAllAttachementOf(Dossier dossier){
        return DaoFactory.getPieceJointeDao().getAllPieceJointe(dossier);
    }
    static {
